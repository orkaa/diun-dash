...
class TestVerifyWebhookToken:
    ...
    def test_no_env_variable_set(self, monkeypatch):
        """Test behavior when DIUN_WEBHOOK_TOKEN is not set (simulated via module variable)."""
        monkeypatch.setattr("src.main.DIUN_WEBHOOK_TOKEN", None)

        # Any token should fail when module variable is None
        with pytest.raises(HTTPException) as exc_info:
    ...
    def test_different_valid_token(self, monkeypatch):
        ...
        monkeypatch.setattr("src.main.DIUN_WEBHOOK_TOKEN", custom_token)
    ...
    def test_case_sensitive_token(self, monkeypatch):
        ...
        monkeypatch.setattr("src.main.DIUN_WEBHOOK_TOKEN", token)
    ...
    def test_token_with_special_characters(self, monkeypatch):
        ...
        monkeypatch.setattr("src.main.DIUN_WEBHOOK_TOKEN", special_token)
    ...
    def test_whitespace_in_token(self, monkeypatch):
        ...
        monkeypatch.setattr("src.main.DIUN_WEBHOOK_TOKEN", token_with_space)
